    ...
    <div className="flex flex-col items-start gap-4 p-4 bg-white rounded-xl">
      <header className="flex h-11 items-center gap-6 w-full">
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className={`inline-flex items-center justify-center gap-2.5 px-2 py-1 rounded-[5px] flex-shrink-0 ${status === "Finalizado" ? "bg-[#BEE7CF]" : "bg-[#fdeb6580]"  } ml-2`}>
            <span className={`font-bold text-[10px] ${status === "Finalizado" ? "text-[#419958]" : "text-[#f5a930]"}`}>
                {status}
            </span>
        </div>
        </div>
        <div className="inline-flex items-center gap-3 ml-auto">
          ...
          <div className={`flex w-[37px] items-center justify-center px-2 py-1 ${managerRating != null ? "bg-[#08605F]" : "bg-[#e6e6e6]"}  rounded`}>
            <span className={`font-bold ${managerRating != null ? "text-[#FFFFFF]" : "text-[#1c1c1c]" } text-sm`}>
