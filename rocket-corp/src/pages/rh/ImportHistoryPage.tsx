...
export default function ImportarHistorico() {
  ...
  return (
    <div className="mt-10 px-6">
      <div className="p-8 bg-white rounded-lg shadow-sm w-full space-y-6">
        <div
          onDrop={handleDrop}
        ...
        >
          ...
          <label
            htmlFor="fileInput"
            className={`mt-4 px-4 py-2 bg-teal-700 text-white rounded cursor-pointer ${
        ...
        {files.length > 0 && (
          <>
            <div className="grid grid-cols-[1fr_120px_60px] font-semibold text-gray-700 px-4 gap-x-4">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <span>Enviando...</span> : <span>Enviar arquivos</span>}
            </button>
          </>
        )}
      </div>
